# Prime Hub / Inventor Hub — pybricks v3.6.1 documentation
...
![../_images/hub-spike-inventor.png](../_images/hub-spike-inventor.png)
...
display.icon(icon)¶
Displays an icon, represented by a matrix of brightness: %
values.

Parameters:
icon (Matrix) – Matrix of intensities (brightness: %). A 2D
...
duration (Number, ms) – Duration of the beep. If the duration is less
