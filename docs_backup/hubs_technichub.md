# Technic Hub — pybricks v3.6.1 documentation
...
![../_images/hub-technic.png](../_images/hub-technic.png)



technic hub

technic hubtop side axiszfront side axisxchannel0channels12

**class TechnicHub(top_side=Axis.Z, front_side=Axis.X, broadcast_channel=None, observe_channels=[])¶**
...
technic hubxacceleration along
...
technic hubxgetangular velocityaround
...
360°technic hubconfigureheading correction
2°/stechnic hubconfigureangular velocity threshold
2500mm/s²technic hubconfigureacceleration threshold
...
technic hub000list withbroadcast
...
technic hubcenterstop button is
technic hubnonestop button is
